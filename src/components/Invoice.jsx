...
function Invoice({ billNumber, customer, items, discount = 0, subtotal = 0, total = 0 }) {
  return (
    <div
      id="invoice" 
      ...
      <div className="flex items-center justify-between border-b border-[hsl(220_13%_91%)] pb-8 mb-10">
        <div className="flex items-center gap-10">
          <img  
            src={companyLogo} 
            alt="Company Logo" 
            className="w-55 h-40 object-contain bg-transparent" // Much bigger, no border, clean
          ...
          <div>
            ...
            {/* <p className="text-[hsl(215.4_16.3%_46.9%)] text-base mt-1">
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="bg-[hsl(220_14%_96%)] p-4 rounded-lg space-y-1">
              <p className="font-semibold text-[hsl(222.2_84%_4.9%)] text-base">{customer.name}</p>
          ...
          <table className="w-full">
            ...
            <tbody>
              {items.map((item, idx) => (
                ...
                >
                  <td className="py-4 px-6 text-sm font-mono text-[hsl(215.4_16.3%_46.9%)]">
                    {item.hsn_code}
                  </td>
                  <td className="py-4 px-6 text-sm font-mono text-[hsl(215.4_16.3%_46.9%)]">
                    {item.sku} 
                  </td>
                  <td className="py-4 px-6 text-sm text-[hsl(222.2_84%_4.9%)] font-medium">
                    {item.name}
                  </td>
                  <td className="py-4 px-6 text-sm text-center text-[hsl(222.2_84%_4.9%)]">
                    {item.quantity}
                  </td>
                </tr>
              ))}
